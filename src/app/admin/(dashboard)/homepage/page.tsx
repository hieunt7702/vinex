...
export default function HomepageManager() {
  ...
  const [config, setConfig] = useState<any>({
    hero: { title: 'Nông sản Việt Nam cao cấp vươn tầm thế giới', subtitle: 'Hàng chục đối tác chiến lược đã được chứng nhận tiêu chuẩn quốc tế', ctaText: 'Khám phá ngay', ctaLink: '/products' },
    ...
    seo: { metaTitle: 'VINEX - Nông sản Việt Nam cao cấp', metaDescription: 'Tìm kiếm nông sản, hạt điều chất lượng xuất khẩu.', keywords: 'nông sản, hạt điều, vinex' },
  });
