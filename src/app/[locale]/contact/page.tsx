              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-light">+84 90 123 4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-light">hello@vinex.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-vinex-black mb-1 uppercase tracking-wider">Văn Phòng & Showroom</p>
          ...
          >
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-sm border border-gray-100">
              ...
              <form className="space-y-6">
                ...
                <button type="button" className="w-full py-4 bg-vinex-blue text-white font-bold uppercase tracking-widest text-sm hover:bg-vinex-blue/90 transition-colors rounded-md">
                  Gửi Thông Tin
                </button>
              </form>
            </div>
