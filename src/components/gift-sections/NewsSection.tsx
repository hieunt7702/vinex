          ...
          {news.map((item, idx) => (
            <article key={idx} className="news-card group cursor-pointer flex flex-col h-full">
              ...
              <div className="flex items-center gap-4 mb-4">
                <span className="text-vinex-blue text-xs font-semibold tracking-widest uppercase">{item.category}</span>
              ...
              <div className="mt-auto">
                <span className="inline-block pb-1 border-b border-black/20 uppercase tracking-widest text-xs font-semibold roup-hover:border-vinex-yellow transition-colors">
                  Read Article
                </span>
              </div>
            </article>
