    ...
    <section ref={container} className="py-16 lg:py-20 px-6 md:px-12 bg-vinex-blue text-vinex-white">
      <div className="max-w-[90rem] mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-sm tracking-widest text-vinex-yellow uppercase mb-4 font-semibold">Corporate Solutions</h2>
          <h3 className="text-4xl md:text-6xl font-light mb-6 font-semibold">Tailored for Every <span className="font-bold">Relationship</span></h3>
