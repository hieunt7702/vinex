      ...
      <div className="max-w-[90rem] mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
          ...
          <div className="flex items-center gap-6 opacity-60 grayscale">
            <span className="text-xl font-semibold tracking-widest">SAMSUNG</span>
            <span className="text-xl font-semibold tracking-widest">VIETCOMBANK</span>
            <span className="text-xl font-semibold tracking-widest">VINGROUP</span>
          </div>
        </div>
          ...
          {reviews.map((rev, idx) => (
            <div key={idx} className="testi-card bg-white/5 p-10 border border-white/10 relative hover:bg-white/10 transition-colors duration-500 group">
              ...
              <div className="flex items-center gap-4 border-t border-white/10 pt-6">
                ...
                <div>
                  <h4 className="font-semibold text-vinex-yellow">{rev.name}</h4>
        ...
        <div className="testi-card relative w-full h-[30vh] md:h-[40vh] bg-gray-900 overflow-hidden group cursor-pointer flex items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <span className="text-sm font-semibold tracking-widest uppercase text-white">Watch Brand Story</span>
          </div>
        </div>
      </div>
    </section>
