        ...
        <div className="flex flex-col xl:flex-row gap-16 xl:gap-12 items-start">
          ...
          <div className="xl:w-[320px] shrink-0">
            ...
            <Link href={`/${lang}/bao-bi-qua-tang`}>
              <GlassButton variant="gold" size="md" className="w-full sm:w-auto" rightIcon={<span>&rarr;</span>}>
                {t.bespoke.cta}
              </GlassButton>
            </Link>
          </div>
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-end gap-3 mb-3">
                          ...
                          <h3 className="text-[13px] font-semibold tracking-widest uppercase">{step.title}</h3>
                        </div>
