  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#f3efe6] min-h-[460px] sm:min-h-[500px] lg:min-h-[540px] xl:min-h-[600px] flex flex-col justify-between">
      ...
      <div className="absolute inset-0 z-0">
        {/* Pure CSS Liquid Glass Refraction Background instead of Image */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#074751] via-[#0b535f] to-[#FAF8F2]/30 mix-blend-multiply opacity-20 pointer-events-none" />
        <div className="absolute top-[10%] left-[20%] w-[500px] h-[500px] bg-teal-400/10 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute bottom-[10%] right-[20%] w-[600px] h-[600px] bg-vinex-gold/15 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[1536px] mx-auto px-4 sm:px-6 md:px-8 xl:px-12 w-full relative z-20 flex-1 flex flex-col justify-center py-12 sm:py-16 lg:py-20">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
          ...
          <div className="w-full lg:w-[50%] xl:w-[46%] flex flex-col items-start text-left">
            ...
            <h2 className="text-[32px] sm:text-[38px] md:text-[44px] lg:text-[48px] xl:text-[52px] leading-[1.15] mb-4 sm:mb-5 tracking-tight text-[#074751] drop-shadow-xs uppercase font-semibold">
