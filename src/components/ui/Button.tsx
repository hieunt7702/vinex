...
export const Button: React.FC<ButtonProps> = ({ variant = 'primary', children, className = '', ...props }) => {
  const baseClasses = "relative overflow-hidden group inline-flex items-center justify-center gap-2 px-8 py-4 font-semibold text-[11px] md:text-xs tracking-widest uppercase transition-all duration-300 rounded-none whitespace-nowrap";
