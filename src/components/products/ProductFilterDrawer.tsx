    ...
    <>
      ...
      <div className="lg:hidden mb-8 flex justify-between items-center bg-white p-2.5 rounded-sm shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[#E8E4D9]/60 gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-vinex-teal text-white px-5 py-2.5 rounded-sm text-sm font-semibold tracking-wide shrink-0 shadow-md shadow-vinex-teal/10 hover:shadow-lg hover:shadow-vinex-teal/20 hover:-translate-y-0.5 hover:bg-[#115a56] active:scale-95 transition-all duration-300"
        >
        ...
        `}>
          ...
          <div className="p-6 pt-4 border-t border-gray-100 flex gap-4 lg:hidden shrink-0 bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.03)] z-10 relative">
            <button
              ...
              className="flex-1 py-3 border border-gray-300 text-gray-700 font-semibold text-[11px] uppercase tracking-widest hover:bg-gray-50 transition-colors"
            >
              Xóa
            </button>
            <Button
